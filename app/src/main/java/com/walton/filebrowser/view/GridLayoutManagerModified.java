...
/**
 * {@link GridLayoutManagerModified} extension which introduces workaround for focus finding bug when
 ...
 */
public class GridLayoutManagerModified extends GridLayoutManager {

    public GridLayoutManagerModified(Context context, AttributeSet attrs, int defStyleAttr,
                                     int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
    }

    public GridLayoutManagerModified(Context context, int spanCount) {
        super(context, spanCount);
    }

    public GridLayoutManagerModified(Context context, int spanCount, int orientation,
