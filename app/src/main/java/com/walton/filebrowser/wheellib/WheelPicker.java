...
//        adapter = new Adapter();
//
//        TypedArray a = context.obtainStyledAttributes(attrs, com.webianks.library.scroll_choice.R.styleable.WheelPicker);
//
//        mItemTextSize = a.getDimensionPixelSize(com.webianks.library.scroll_choice.R.styleable.WheelPicker_scroll_item_text_size,
//                getResources().getDimensionPixelSize(com.webianks.library.scroll_choice.R.dimen.WheelItemTextSize));
//        mVisibleItemCount = a.getInt(com.webianks.library.scroll_choice.R.styleable.WheelPicker_scroll_visible_item_count, 7);
//        selectedItemPosition = a.getInt(com.webianks.library.scroll_choice.R.styleable.WheelPicker_scroll_selected_item_position, 0);
//        textMaxWidthPosition = a.getInt(com.webianks.library.scroll_choice.R.styleable.WheelPicker_scroll_maximum_width_text_position, -1);
//        maxWidthText = a.getString(com.webianks.library.scroll_choice.R.styleable.WheelPicker_scroll_maximum_width_text);
//        mSelectedItemTextColor = a.getColor(com.webianks.library.scroll_choice.R.styleable.WheelPicker_scroll_selected_item_text_color, -1);
//        mItemTextColor = a.getColor(com.webianks.library.scroll_choice.R.styleable.WheelPicker_scroll_item_text_color, 0xFF424242);
//        backgroundColor = a.getColor(com.webianks.library.scroll_choice.R.styleable.WheelPicker_scroll_background_color, 0xFFF5F5F5);
//        backgroundOfSelectedItem = a.getColor(com.webianks.library.scroll_choice.R.styleable.WheelPicker_scroll_selected_item_background, 0xFFFFFFFF);
//        mItemSpace = a.getDimensionPixelSize(com.webianks.library.scroll_choice.R.styleable.WheelPicker_scroll_item_space,
//                getResources().getDimensionPixelSize(com.webianks.library.scroll_choice.R.dimen.WheelItemSpace));
//        hasIndicator = a.getBoolean(com.webianks.library.scroll_choice.R.styleable.WheelPicker_scroll_indicator, false);
//        mIndicatorColor = a.getColor(com.webianks.library.scroll_choice.R.styleable.WheelPicker_scroll_indicator_color, 0xFFDDDDDD);
//        mIndicatorSize = a.getDimensionPixelSize(com.webianks.library.scroll_choice.R.styleable.WheelPicker_scroll_indicator_size,
//                getResources().getDimensionPixelSize(com.webianks.library.scroll_choice.R.dimen.WheelIndicatorSize));
//        hasAtmospheric = a.getBoolean(com.webianks.library.scroll_choice.R.styleable.WheelPicker_scroll_atmospheric, false);
//        mItemAlign = a.getInt(com.webianks.library.scroll_choice.R.styleable.WheelPicker_scroll_item_align, ALIGN_CENTER);
//        a.recycle();
//
