...
public class CircularListView extends ListView implements AbsListView.OnScrollListener {
    ...
    private int mSmoothScrollDuration = 2000;
    ...
    public void stopScroll(ListView view)
    {
        try
        {
            ...
            {
                @SuppressLint("SoonBlockedPrivateApi") Method method = Class.forName("android.widget.AbsListView$FlingRunnable").getDeclaredMethod("endFling");
