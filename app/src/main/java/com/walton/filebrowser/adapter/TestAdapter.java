...
public class TestAdapter extends BaseAdapter {
    ...
    public TestAdapter(Context context, List<FileModel> data, File[] fileList) {
...
//                }else{
//                    viewHolder.imgFiles.setImageResource(R.drawable.ic_folder);
//                }
//            }else{
//                if(isEmpty){
//                    viewHolder.imgFiles.setImageResource(R.drawable.file_icon_folder_h);
...
//                    mImageLoader.loadImage(mIvIcon);
            ...
            }else if(fileName.endsWith(".mp3") || fileName.endsWith(".aac") || fileName.endsWith(".wav")){
...
//                        .into(viewHolder.imgFiles);
                ...
                if(apkIcon==null){
                    ...
                    viewHolder.imgFiles.setBackgroundResource(R.drawable.icon_video_close);
                }else{
