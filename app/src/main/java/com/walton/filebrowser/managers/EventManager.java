...
public class EventManager {
    ...
    public void init(Context context, ArrayList<File> filesAndFolders, GridViewAdapter adapter){
    ...
    public void open(File file) {
        ...
        if(file.isFile()) {
            ...
            populateList(file);
//            displayFragment.setPageTitle(file.getName());
...
//        displayFragment.setPageTitle(file.getName());
    ...
    public void share(ArrayList<File> files) {
        ...
        Uri contentUri = FileProvider.getUriForFile(context, "com.walton.filebrowser.fileprovider", files.get(0));
        ClipData clipData = ClipData.newRawUri(null, contentUri);

        for (int i = 1; i < files.size() ; i++) {
            Uri otherUri = FileProvider.getUriForFile(context, "com.walton.filebrowser.fileprovider", files.get(i));
