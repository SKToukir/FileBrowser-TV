    ...
    void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            a = context.getTheme().obtainStyledAttributes(
                    attrs,
                    R.styleable.StorageProgressBar,
                    0, 0);
        } else {
        ...
        try {
            mDrawText = a.getBoolean(R.styleable.StorageProgressBar_showProgressText, false);

            mBackgroundColor = a.getColor(R.styleable.StorageProgressBar_backgroundColor, android.R.color.darker_gray);
            mPrimaryProgressColor = a.getColor(R.styleable.StorageProgressBar_progressColor, android.R.color.darker_gray);
            mSecondaryProgressColor = a.getColor(R.styleable.StorageProgressBar_secondaryProgressColor, android.R.color.black);

            mProgress = a.getInt(R.styleable.StorageProgressBar_progress, 0);
            mSecodaryProgress = a.getInt(R.styleable.StorageProgressBar_secondaryProgress, 0);

            mStrokeWidth = a.getDimensionPixelSize(R.styleable.StorageProgressBar_strokeWidth, 20);
            mTextColor = a.getColor(R.styleable.StorageProgressBar_textColor, android.R.color.black);

            mPrimaryCapSize = a.getInt(R.styleable.StorageProgressBar_primaryCapSize, 20);
            mSecondaryCapSize = a.getInt(R.styleable.StorageProgressBar_secodaryCapSize, 20);

            mIsPrimaryCapVisible = a.getBoolean(R.styleable.StorageProgressBar_primaryCapVisibility, true);
            mIsSecondaryCapVisible = a.getBoolean(R.styleable.StorageProgressBar_secodaryCapVisibility, true);
        } finally {
            a.recycle();
        }
