...
public class WaveLoadingView2 extends View {
    ...
    public WaveLoadingView2(final Context context) {
        this(context, null);
    }
    ...
    public WaveLoadingView2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void updateWaveShader() {
        ...
        if (bitmapBuffer == null || haveBoundsChanged()) {
            ...
            if (width > 0 && height > 0) {
                ...
                // First wave
                wavePaint.setColor(Color.parseColor("#B1005A"));//adjustAlpha(getThirdWaveColor(), 0.3f));
