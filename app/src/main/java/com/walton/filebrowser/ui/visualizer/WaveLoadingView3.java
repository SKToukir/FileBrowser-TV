...
public class WaveLoadingView3 extends View {
    ...
    public WaveLoadingView3(final Context context) {
        this(context, null);
    }

    public WaveLoadingView3(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WaveLoadingView3(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void updateWaveShader() {
        ...
        if (bitmapBuffer == null || haveBoundsChanged()) {
            ...
            if (width > 0 && height > 0) {
                ...
                // First wave
                wavePaint.setColor(Color.parseColor("#56F26E5F"));//adjustAlpha(getThirdWaveColor(), 0.3f));
...
//
//                // Third Wave
//                wavePaint.setColor(adjustAlpha(Color.parseColor("#f26e5f"), 0.2f));
//                final int wave3Shift = (int) (defaultWaveLength / 2);
//                for (int beginX = 0; beginX < endX; beginX++) {
...
//        mWaveShader = null;
    ...
    public void setThirdWaveColor(int color){
        this.mThirdWaveColor = color;
    }

    public int getThirdWaveColor(){
        return mThirdWaveColor;
    }
    ...
    private void initAnimation() {
        ...
        waveShiftAnim = ObjectAnimator.ofFloat(this, "waveShiftRatio", 1f, 0f);
