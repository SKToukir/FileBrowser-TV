...
public class EqualizerView extends LinearLayout {
    ...
    int foregroundColor, foregroundColor2, foregroundColor3;
    int duration;
    ...
    private void setAttrs(Context context, AttributeSet attrs) {
        ...
        try {
            foregroundColor = a.getInt(R.styleable.EqualizerView_foregroundColor, Color.parseColor("#250B60"));
            foregroundColor2 = a.getInt(R.styleable.EqualizerView_foregroundColor, Color.parseColor("#B1005A"));
            foregroundColor3 = a.getInt(R.styleable.EqualizerView_foregroundColor, Color.parseColor("#56F26E5F"));
    ...
    private void initViews() {
        ...
        musicBar2.setBackgroundColor(foregroundColor2);
        musicBar3.setBackgroundColor(foregroundColor3);
        setPivots();
    }
